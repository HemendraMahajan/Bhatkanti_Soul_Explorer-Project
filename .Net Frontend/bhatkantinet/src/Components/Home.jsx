        ...
        <section className={styleHome.reviewSection}>
            ...
            <div className="row text-center">
                ...
                <div className={`col-md-4 mb-5 mb-md-0`} style={{padding: "10px"}}>
                    <div className={styleHome.reviewCard}>
                        <div className="d-flex justify-content-center mb-4">
                            <img src="https://media.istockphoto.com/id/1313502972/photo/portrait-of-beautiful-woman-having-fun.webp?b=1&s=170667a&w=0&k=20&c=wOZWMdDtNysiDBRfB-PH1MfibKExER4w9trL81rT0PQ=" alt=".."
                            className="rounded-circle shadow-1-strong" style={{width: "150px", height: "150px"}}  />
                        </div>
                ...
                <div className={`col-md-4 mb-0`} style={{padding: "10px"}}>
                    <div className={styleHome.reviewCard}>
                        <div className="d-flex justify-content-center mb-4">
                            <img src="https://i.pinimg.com/originals/48/6f/23/486f2396c4a7928ddee07ca627066fe3.jpg" alt=".."
                            className="rounded-circle shadow-1-strong" style={{width: "150px", height: "150px"}}  />
                        </div>
